...
results <- data.frame(
  ...
  `R de Pearson` = c(
    cor.test(data2$tfr, data2$femWork)$estimate,
...
Finalmente, podemos concluir que todas las variables analizadas se relacionan con la tasa de fecundidad a nivel país. Además, la variable que se relaciona más sería la esperanza de vida de las mujeres, ya que su coeficiente es el más cercano a 1, aún cuando su relación sea negativa. Por otro lado, la variable que se relaciona menos es el trabajo masculino. 
